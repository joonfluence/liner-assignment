...
INSERT INTO users (id, name, user_name, created_at, created_by, updated_at, updated_by)
...
INSERT INTO pages (id, url, title, user_id, created_at, created_by, updated_at, updated_by) VALUES (1, 'https://example.com/page1', 'Page 1', 1, '2025-01-27 07:39:06', '1', '2025-01-27 11:12:23', '1');
INSERT INTO pages (id, url, title, user_id, created_at, created_by, updated_at, updated_by) VALUES (2, 'https://example.com/page2', 'Page 2', 1, '2025-01-27 07:39:06', '2', '2025-01-27 11:12:23', '2');
INSERT INTO pages (id, url, title, user_id, created_at, created_by, updated_at, updated_by) VALUES (3, 'https://example.com/page3', 'Page 3', 1, '2025-01-27 07:39:06', '3', '2025-01-27 11:12:23', '3');
INSERT INTO pages (id, url, title, user_id, created_at, created_by, updated_at, updated_by) VALUES (4, 'https://example.com/page4', 'Page 4', 1, '2025-01-27 07:39:06', '4', '2025-01-27 11:12:23', '4');
INSERT INTO pages (id, url, title, user_id, created_at, created_by, updated_at, updated_by) VALUES (5, 'https://example.com/page5', 'Page 5', 1, '2025-01-27 07:39:06', '5', '2025-01-27 11:12:23', '5');
...
INSERT INTO feed_items (id, user_id, page_id, created_at, created_by, updated_at, updated_by, visibility, first_highlighted_at)
VALUES (1, 1, 1, NOW(), 1, NOW(), 1, 'PUBLIC', '2025-01-27 07:39:06.000000'),
       (2, 2, 2, NOW(), 2, NOW(), 2, 'MENTIONED', '2025-01-27 08:39:06.000000'),
       (3, 3, 3, NOW(), 3, NOW(), 3, 'PRIVATE', '2025-01-27 09:39:06.000000'),
       (4, 4, 4, NOW(), 4, NOW(), 4, 'PUBLIC', '2025-01-27 10:39:06.000000'),
       (5, 5, 5, NOW(), 5, NOW(), 5, 'MENTIONED', '2025-01-27 11:39:06.000000');
